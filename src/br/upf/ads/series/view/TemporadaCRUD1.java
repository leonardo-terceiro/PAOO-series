 ...
 */
public class TemporadaCRUD1 extends javax.swing.JDialog {

    /**
     * Creates new form TemporadaCRUD1
     */
    public TemporadaCRUD1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TemporadaCRUD1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TemporadaCRUD1 dialog = new TemporadaCRUD1(new javax.swing.JFrame(), true);
